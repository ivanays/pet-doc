...
//Пупапы для входа и регистрации
...
function popupOpen(curentPopup) {
    if (curentPopup && unlock) {
        ...
        if (popupActive) {
            ...
            // const popupOwner = popupActive.classList.contains("popup-owner");
            // const popupHelp = curentPopup.classList.contains("popup-help");
            // if (!popupOwner && popupHelp) {
            //     popupClose(popupActive, false);
            // }
        } else {
            bodyLock();
